...
// let firstObject = { value: 1}
// let secondObject = firstObject; // pointer to firstObject
// secondObject.value = 3;
// firstObject.value = 9; // order matter..the one that's lower will be the value

// firstObject; // value: 9
// secondObject; // value: 9

// let firstArray = [1, 2, 3, 4];
// let secondArray = firstArray; // reference to the array in memory
...
// // changeValue(firstObject);
// changeValue(secondObject); // second object is alias of firstObject
...
const getNames = (arr) => {
  let output = [];
  const reversed = arr.map( obj => {
    let names = obj.name.split('').reverse().join('')
    output.push(names);
    })
  return output;
};
