...
const raisedToTheThird = (arr) => {
  const output = [];
  arr.forEach((element) => {
    const exponent = Math.pow(element, 3);
...
const addOne = (arr) => {
  const output = arr.map((element) => element + 1);
  return output;
};
...
const addQuestion = (arr) => {
  const output = arr.map((element) => element + "?");
  return output;
};
...
const forLoopTwoToThe = (arr) => {
  ...
  for (const element of arr) {
    let twoToThe = Math.pow(2, element);
    output.push(twoToThe);
  }
  return output;
};
